...
public class HoyAdapter extends FirestoreRecyclerAdapter<Amigo, HoyAdapter.ViewHolder> {

    public HoyAdapter(@NonNull FirestoreRecyclerOptions<Amigo> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull HoyAdapter.ViewHolder viewHolder, int i, @NonNull Amigo amigo) {
    ...
    @NonNull
    @Override
    public HoyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_amigo_single, parent, false);
        return  new HoyAdapter.ViewHolder(view);
    }
